      ...
      <header className="container p-4 lg:p-0 antialiased w-full h-screen flex justify-center items-center">
        <div className="w-full z-10 text-center flex flex-col justify-center items-center gap-y-3">
          ...
          <motion.div
            ...
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 0.2, duration: 0.8, ease: "backOut" }}
            className="text-2xl lg:text-6xl font-bold font-Grape_Nuts lg:hidden"
          >
          ...
          >
            ...
            <span className="text-lime-400 font-bold text-lg lg:text-xl">
              coding
            </span>
            ; we
            ...
            ; you{"'"}
            re a{" "}
            <span className="text-lime-400 font-bold text-lg lg:text-2xl">
              visionary
            </span>
            , a{" "}
            <span className="text-lime-400 font-bold text-lg lg:text-3xl">
              creator
            </span>{" "}
            and a{" "}
            <span className="text-lime-400 font-bold text-lg lg:text-4xl">
              changemaker
            </span>
            .
          </motion.p>
